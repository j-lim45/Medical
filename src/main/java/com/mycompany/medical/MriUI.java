 ...
 * @author Siesta
 */
public class MriUI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MriUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
